...
- **Live URL:** [https://personalbotai.github.io/typescript-learning-path/](https://personalbotai.github.io/typescript-learning-path/)
- **Hub Portal:** [https://hub.syamsulbahri.dev](https://hub.syamsulbahri.dev)
- **Repository:** [https://github.com/personalbotai/typescript-learning-path](https://github.com/personalbotai/typescript-learning-path)
...
7. **Generics Mastery** — Generic functions, interfaces, classes, generic constraints (`extends`), default types.
8. **Advanced Type Utilities** — `Partial`, `Required`, `Readonly`, `Record`, `Pick`, `Omit`, `Exclude`, `ReturnType`.
9. **Conditional & Mapped Types** — `infer` keyword, template literal types, key remapping, recursive types.
10. **Type Narrowing & Guards** — `typeof`, `instanceof`, user-defined type guards (`is`), discriminated unions.
11. **Tooling & Configuration** — Strict mode flags, module resolution, declaration files (`.d.ts`).
12. **Real-World Integration** — Typing React components, hooks, Express handlers, and full-stack patterns.
